...
class UsbKeyboardDevice {
 public:
  ...
  void clearKeys(byte modifiers) {
    memset(reportBuffer, 0, sizeof(reportBuffer));
    reportBuffer[0] = modifiers;
    usbSetInterrupt(reportBuffer, sizeof(reportBuffer));
  }

  void sendModifiers(byte modifiers) {
    reportBuffer[0] = modifiers;
    usbSetInterrupt(reportBuffer, sizeof(reportBuffer));
  }
  ...
  void sendKeyrelease(byte keyStroke, byte modifiers) {
    reportBuffer[0] = modifiers;
  ...
  void sendKeyStroke3(byte keyStroke, byte modifiers) {
